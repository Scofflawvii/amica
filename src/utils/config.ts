...
export const defaults = {
  ...
  show_arbius_introduction:
    process.env.NEXT_PUBLIC_SHOW_ARBIUS_INTRODUCTION ?? "false",
  show_add_to_homescreen:
    process.env.NEXT_PUBLIC_SHOW_ADD_TO_HOMESCREEN ?? "true",
  ...
  youtube_videoid: "",
  animation_url:
    process.env.NEXT_PUBLIC_ANIMATION_URL ?? "/animations/idle_loop.vrma",
  ...
  openrouter_model:
    process.env.NEXT_PUBLIC_OPENROUTER_MODEL ?? "openai/gpt-3.5-turbo",
  tts_muted: "false",
  ...
  vision_system_prompt:
    ...
    `Look at the image as you would if you are a human, be concise, witty and charming.`,
  ...
  vision_ollama_url:
    process.env.NEXT_PUBLIC_VISION_OLLAMA_URL ?? "http://localhost:11434",
  vision_ollama_model: process.env.NEXT_PUBLIC_VISION_OLLAMA_MODEL ?? "llava",
  whispercpp_url:
    process.env.NEXT_PUBLIC_WHISPERCPP_URL ?? "http://localhost:8080",
  ...
  openai_whisper_model:
    process.env.NEXT_PUBLIC_OPENAI_WHISPER_MODEL ?? "whisper-1",
  openai_tts_apikey: process.env.NEXT_PUBLIC_OPENAI_TTS_APIKEY ?? "",
  openai_tts_url:
    process.env.NEXT_PUBLIC_OPENAI_TTS_URL ?? "https://api.openai.com",
  ...
  rvc_url:
    process.env.NEXT_PUBLIC_RVC_URL ?? "http://localhost:8001/voice2voice",
  ...
  coquiLocal_url:
    process.env.NEXT_PUBLIC_COQUILOCAL_URL ?? "http://localhost:5002",
  ...
  piper_url:
    process.env.NEXT_PUBLIC_PIPER_URL ?? "https://i-love-amica.com:5000/tts",
  ...
  elevenlabs_model:
    process.env.NEXT_PUBLIC_ELEVENLABS_MODEL ?? "eleven_monolingual_v1",
  ...
  coqui_voice_id:
    process.env.NEXT_PUBLIC_COQUI_VOICEID ??
    "71c6c3eb-98ca-4a05-8d6b-f8c2b5f9f3a3",
  amica_life_enabled: process.env.NEXT_PUBLIC_AMICA_LIFE_ENABLED ?? "true",
  reasoning_engine_enabled:
    process.env.NEXT_PUBLIC_REASONING_ENGINE_ENABLED ?? "false",
  reasoning_engine_url:
    process.env.NEXT_PUBLIC_REASONING_ENGINE_URL ??
    "https://i-love-amica.com:3000/reasoning/v1/chat/completions",
  ...
  system_prompt:
    ...
    `Assume the persona of Amica, a feisty human with extraordinary intellectual capabilities but a notably unstable emotional spectrum. 
