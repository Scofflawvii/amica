      ...
      <div className="mt-4 max-w-md rounded-xl sm:col-span-3">
        ...
        {!error && loaded && (
          <h1 className="text-lg">
            {t("Import")} {loaded ? (name ? `“${name}”` : "Amica") : "..."}
          </h1>
        )}
      </div>
              ...
              <>
                <div className="mt-2 max-w-md rounded-xl sm:col-span-3">
                  <button
                    ...
                    className="bg-secondary hover:bg-secondary-hover ml-2 inline-flex items-center rounded-md px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none"
                ...
                {isTauri() && (
                  <div className="mt-2 max-w-md rounded-xl sm:col-span-3">
                    <Link href="/">
                      <button className="bg-danger hover:bg-danger-hover disabled:hover:bg-danger mt-6 ml-2 inline-flex items-center rounded-md px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none disabled:opacity-50">
                        {t("Cancel")}
                      </button>
                    </Link>
                  </div>
