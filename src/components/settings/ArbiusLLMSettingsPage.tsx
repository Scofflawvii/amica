...
// import { SecretTextInput } from '@/components/secretTextInput'; // Removed unused import
...
export function ArbiusLLMSettingsPage({
  ...
  return (
    <BasicPage
      ...
      description={t(
        "ArbiusLLMSettings_desc",
        "Configure the settings for the Arbius LLM chatbot backend.",
      )}>
      {config("chatbot_backend") !== "arbius_llm" && (
        <NotUsingAlert>
          You are not currently using Arbius as your ChatBot backend. These
