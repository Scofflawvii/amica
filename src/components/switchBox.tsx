  ...
  return (
    <Switch.Group as="div" className="flex items-center">
      <Switch
        ...
        className={clsx(
          disabled
            ? "bg-surface-alt/40 cursor-not-allowed"
            : enabled
              ? "bg-primary"
              : "bg-surface-alt/70",
          "focus-visible:ring-primary focus-visible:ring-offset-surface relative ml-2 inline-flex h-6 w-11 flex-shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",
  ...
  return (
    <Switch.Group as="div" className="flex flex-col items-center">
      <Switch
        ...
        className={clsx(
          enabled ? "bg-primary/80" : "bg-surface-alt/70",
          "focus-visible:ring-primary focus-visible:ring-offset-surface relative inline-flex h-8 w-4 items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",
        )}
        {...rest}>
