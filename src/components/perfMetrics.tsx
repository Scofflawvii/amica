...
export const PerfMetrics: React.FC = () => {
  ...
  return (
    <div className="border-border/40 bg-surface-alt/60 my-2 rounded-md border p-2 font-mono text-xs">
      ...
      <div className="text-muted mt-2 flex flex-wrap items-center gap-2 text-[10px]">
        ...
        {ttsBackendCounts.map((v) => (
          <span
            key={v}
            className="bg-surface-alt/70 ring-border/20 rounded px-1 py-0.5 ring-1">
            {v}
          </span>
        ))}
      </div>
